              ...
              <div class="bar">
                ...
                <div class="bar2">
                  <form action="index.php" method="get">
                    ...
                    <div class="item1">
                      <input class="enter_y" type="number" name="y" value="<?php echo date('Y');?>" min="100" max="9999"
